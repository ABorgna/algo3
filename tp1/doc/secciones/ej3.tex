...
A continuación se presentan una serie de experimentos que ponen a prueba el algoritmo propuesto en esta sección y ayudan a probar que la complejidad temporal propuesta anteriormente es correcta.

\subsubsection{Variando $\sum C_i$}

Dejando fijas las capacidades máximas de cada mochila, se obtuvieron los siguientes resultados de tiempo de ejecución en función de $\sum C_i$ para una y tres mochilas:

[Gráficos de tiempo en función de la suma]
...
[Gráficos de tiempo en función de la productoria]