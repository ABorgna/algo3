...
\subsection{Solución y Correctitud}
	...
	$P$ = $\sum_{i = 0}^{\left \lfloor{log(P)}\right \rfloor + 1} A_i*3^{i}$ y nos alcanza con tomar $I$ = $\bigl ( \ \bigcup_{i=0}^{\left \lfloor{log(P)}\right \rfloor + 1} \{A_i\} \ \bigr ) \setminus \{0\} \ \ \wedge \ \ D = \emptyset $
	\\
